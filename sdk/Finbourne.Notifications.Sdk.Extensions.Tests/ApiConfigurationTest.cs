...
namespace Finbourne.Notifications.Sdk.Extensions.Tests
{
    ...
    public class ApiConfigurationTest
    {
        ...
        {
            ApiConfiguration config = GetApiConfiguration();
            config.NotificationsUrl = String.Empty;
            Assert.IsTrue(config.HasMissingConfig());
        }
        ...
        public void ApiConfiguration_MissingConfig_Missing_NotificationsUrl_Returns_Correct_String()
        {
            ...
            List<string> missingList = config.GetMissingConfig();
            Assert.That(missingList.Count, Is.EqualTo(1), "GetMissingConfig list contains one item");
            Assert.That(missingList[0], Is.EqualTo(nameof(config.NotificationsUrl)), "GetMissingConfig list string correct");
        }
        ...
        private ApiConfiguration GetApiConfiguration() {
            ...
            {
                NotificationsUrl = "https://sub-domain.lusid.com/api",
